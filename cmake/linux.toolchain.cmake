...
if(NOT DEFINED TOOLCHAIN_SUMMARY)
    message(STATUS "${SYSROOT_DISTRO}-${SYSROOT_VERSION}-${SYSROOT_ARCH} / ${CROSS_TARGET} / ${CMAKE_SYSTEM_PROCESSOR}")
endif()
set(TOOLCHAIN_SUMMARY CACHE STRING "" FORCE)
