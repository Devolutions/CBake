...
if(NOT DEFINED CROSS_TRIPLET)
	message(FATAL_ERROR "CROSS_TRIPLET is not defined")
endif()

message(STATUS "CMAKE_SYSTEM_PROCESSOR: ${CMAKE_SYSTEM_PROCESSOR}")
message(STATUS "CROSS_TRIPLET: ${CROSS_TRIPLET}")
...
set(ENV{PKG_CONFIG_LIBDIR} "${CMAKE_SYSROOT}/usr/lib/pkgconfig:${CMAKE_SYSROOT}/usr/lib/${CROSS_TRIPLET}/pkgconfig:${CMAKE_SYSROOT}/usr/share/pkgconfig")
